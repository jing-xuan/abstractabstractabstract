...
test.each([
    ...
    if (passing) {
        return (0, testing_1.expectResult)((0, formatters_1.stripIndent)(snippet), { chapter, native: chapter < 100 }).toEqual(returnValue);
    }
    else {
        return (0, testing_1.snapshotFailure)((0, formatters_1.stripIndent)(snippet), { chapter }, 'fails');
    }
});
