...
const non_det_interpreter_1 = require("./non-det-interpreter");
test('An element of', () => __awaiter(void 0, void 0, void 0, function* () {
    yield (0, non_det_interpreter_1.testNonDeterministicCode)(`an_element_of(list(1, 2, list(3, 4)));`, [1, 2, [3, [4, null]]]);
}));
test('An integer between', () => __awaiter(void 0, void 0, void 0, function* () {
    yield (0, non_det_interpreter_1.testNonDeterministicCode)('an_integer_between(5, 10);', [5, 6, 7, 8, 9, 10]);
}));
test('Pythagorean triple', () => __awaiter(void 0, void 0, void 0, function* () {
    yield (0, non_det_interpreter_1.testNonDeterministicCode)(`function a_pythagorean_triple_between(low, high) {
       ...
       a_pythagorean_triple_between(3, 5);`, [[3, [4, [5, null]]]]);
}));
test('Multiple dwelling problem', () => __awaiter(void 0, void 0, void 0, function* () {
    yield (0, non_det_interpreter_1.testNonDeterministicCode)(`
...
test('Language parsing', () => __awaiter(void 0, void 0, void 0, function* () {
    yield (0, non_det_interpreter_1.testNonDeterministicCode)(`
    let unparsed = null;
...
//# sourceMappingURL=non-det-sicp-examples.js.map