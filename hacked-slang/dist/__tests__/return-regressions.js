...
test('Calling unreachable results in error', () => {
    return (0, testing_1.expectParsedError)(`
...
test('Bare early returns work', () => {
    return (0, testing_1.expectResult)(`
    function unreachable() {
      return 1 < true; // Will cause an error
    }
    function f() {
    ...
    f();
  `, { native: true }).toMatchInlineSnapshot(`1`);
});
// This is bad practice. Don't do this!
test('Recursive call early returns work', () => {
    ...
    f();
  `, { native: true }).toMatchInlineSnapshot(`3`);
});
// This is bad practice. Don't do this!
...
test('Bare early returns in while loops work', () => {
    ...
    f();
  `, { chapter: 3, native: true }).toMatchInlineSnapshot(`1`);
});
// This is bad practice. Don't do this!
test('Recursive call early returns in while loops work', () => {
    ...
    f();
  `, { chapter: 3, native: true }).toMatchInlineSnapshot(`3`);
});
// This is bad practice. Don't do this!
...
//# sourceMappingURL=return-regressions.js.map