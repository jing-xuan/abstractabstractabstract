...
test('stringify is fast', () => {
    return expect((0, testing_1.testSuccess)((0, formatters_1.stripIndent) `
        ...
        `, { chapter: 3, native: false }).then(testResult => testResult.result)).resolves.toBeLessThan(2000);
...
test('display_list with stringify is linear runtime', () => {
    ...
    const noDisplayList = (v, s = placeholder) => {
        ...
        return (0, stringify_1.stringify)(list.rawDisplayList((x) => x, v, s === placeholder ? undefined : s));
    };
    return expect((0, testing_1.testSuccess)((0, formatters_1.stripIndent) `
      const build_inf = (i, f) => {
        const t = list(f(i));
...
//# sourceMappingURL=stringify-benchmark.js.map