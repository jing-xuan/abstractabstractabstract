...
test('Empty code returns undefined', () => {
    return (0, testing_1.expectResult)('').toBe(undefined);
});
test('Single string self-evaluates to itself', () => {
    return (0, testing_1.expectResult)("'42';").toBe('42');
});
test('Multiline string self-evaluates to itself', () => {
    return (0, testing_1.expectResult)('`1\n1`;').toBe(`1
1`);
});
test('Allow display to return value it is displaying', () => {
    return (0, testing_1.expectResult)('25*(display(1+1));').toBe(50);
});
test('Single number self-evaluates to itself', () => {
    return (0, testing_1.expectResult)('42;').toBe(42);
});
test('Single boolean self-evaluates to itself', () => {
    return (0, testing_1.expectResult)('true;').toBe(true);
});
test('Arrow function definition returns itself', () => {
    return (0, testing_1.expectResult)('() => 42;').toMatchInlineSnapshot(`[Function]`);
});
test('Builtins hide their implementation when stringify', () => {
    return (0, testing_1.expectResult)('stringify(pair);', { chapter: 2, native: true }).toMatchInlineSnapshot(`
...
test('Builtins hide their implementation when toString', () => {
    return (0, testing_1.expectResult)('toString(pair);', { chapter: 2, native: true, testBuiltins: { toString } })
...
test('Objects toString matches up with JS', () => {
    return (0, testing_1.expectToMatchJS)('toString({a: 1});', {
        chapter: 100,
        native: true,
...
test('Arrays toString matches up with JS', () => {
    return (0, testing_1.expectToMatchJS)('toString([1, 2]);', {
        chapter: 3,
        native: true,
        testBuiltins: { toString }
    });
...
test('functions toString (mostly) matches up with JS', () => {
    return (0, testing_1.expectToLooselyMatchJS)((0, formatters_1.stripIndent) `
  function f(x) {
    return 5;
  }
...
test('primitives toString matches up with JS', () => {
    return (0, testing_1.expectToMatchJS)((0, formatters_1.stripIndent) `
    toString(true) +
    toString(false) +
    toString(1) +
    toString(1.5) +
...
test('parseError for missing semicolon', () => {
    return (0, testing_1.expectParsedError)('42').toMatchInlineSnapshot(`"Line 1: Missing semicolon at the end of statement"`);
});
test('parseError for template literals with expressions', () => {
    return (0, testing_1.expectParsedError)('`${1}`;').toMatchInlineSnapshot(`"Line 1: Expressions are not allowed in template literals (\`multiline strings\`)"`);
});
test('Simple arrow function infinite recursion represents CallExpression well', () => {
    return (0, testing_1.expectParsedErrorNoErrorSnapshot)('(x => x(x)(x))(x => x(x)(x));').toMatchInlineSnapshot(`
            "Line 1: Maximum call stack size exceeded
              x(x => x(x)(x))..  x(x => x(x)(x))..  x(x => x(x)(x)).."
          `);
}, 30000);
test('Simple function infinite recursion represents CallExpression well', () => {
    return (0, testing_1.expectParsedErrorNoErrorSnapshot)('function f(x) {return x(x)(x);} f(f);')
        .toMatchInlineSnapshot(`
            "Line 1: Maximum call stack size exceeded
              x(function f(x) {
              return x(x)(x);
...
test('Cannot overwrite consts even when assignment is allowed', () => {
    ...
    test();
  `, { chapter: 3, native: true }).toMatchInlineSnapshot(`"Line 3: Cannot assign new value to constant constant."`);
});
test('Assignment has value', () => {
    ...
    let b = a = 4;
    b === 4 && a === 4;
  `, { chapter: 3, native: true }).toBe(true);
});
...
test('Arrow function infinite recursion with list args represents CallExpression well', () => {
    return (0, testing_1.expectParsedErrorNoErrorSnapshot)((0, formatters_1.stripIndent) `
...
test('Functions passed into non-source functions remain equal', () => {
  ...
  `, { chapter: 3, testBuiltins: { 'identity(x)': (x) => x }, native: true }).toBe(true);
});
test('Accessing array with nonexistent index returns undefined', () => {
    return (0, testing_1.expectResult)((0, formatters_1.stripIndent) `
    const a = [];
    a[1];
  `, { chapter: 4, native: true }).toBe(undefined);
});
test('Accessing object with nonexistent property returns undefined', () => {
    return (0, testing_1.expectResult)((0, formatters_1.stripIndent) `
    const o = {};
    o.nonexistent;
  `, { chapter: 100, native: true }).toBe(undefined);
});
test('Simple object assignment and retrieval', () => {
    ...
    o.a = 1;
    o.a;
  `, { chapter: 100, native: true }).toBe(1);
});
...
test('test true conditional expression', () => {
    return (0, testing_1.expectToMatchJS)('true ? true : false;', { native: true });
});
test('test false conditional expression', () => {
    return (0, testing_1.expectToMatchJS)('false ? true : false;', { native: true });
});
test('test false && true', () => {
    return (0, testing_1.expectToMatchJS)('false && true;', { native: true });
});
test('test false && false', () => {
    return (0, testing_1.expectToMatchJS)('false && false;', { native: true });
});
test('test true && false', () => {
    return (0, testing_1.expectToMatchJS)('true && false;', { native: true });
});
test('test true && true', () => {
    return (0, testing_1.expectToMatchJS)('true && true;', { native: true });
});
test('test && shortcircuiting', () => {
    return (0, testing_1.expectToMatchJS)('false && 1();', { native: true });
});
test('test false || true', () => {
    return (0, testing_1.expectToMatchJS)('false || true;', { native: true });
});
...
test('test || shortcircuiting', () => {
    return (0, testing_1.expectToMatchJS)('true || 1();', { native: true });
});
test('Rest parameters work', () => {
    ...
    rest(1, 2); // no error
    rest(1, 2, ...[3, 4, 5],  ...[6, 7], ...[]);
  `, { native: true, chapter: 3 }).toMatchInlineSnapshot(`28`);
});
test('Test context reuse', () => __awaiter(void 0, void 0, void 0, function* () {
    const context = (0, testing_1.createTestContext)({ chapter: 4 });
    const init = (0, formatters_1.stripIndent) `
  let i = 0;
  function f() {
    i = i + 1;
    return i;
  ...
  i;
  `;
    yield (0, testing_1.expectResult)(init, { context, native: true }).toBe(0);
    yield (0, testing_1.expectResult)('i = 100; f();', { context, native: true }).toBe(101);
    yield (0, testing_1.expectResult)('f(); i;', { context, native: true }).toBe(102);
    return (0, testing_1.expectResult)('i;', { context, native: true }).toBe(102);
}));
...
function expectResultsToMatch(actualResult, expectedResult) {
...
test('Find variable declaration in global scope', () => {
  ...
  `;
    ...
    const actual = (0, index_1.findDeclaration)(code, context, { line: 6, column: 0 });
...
test('Find variable declaration in global scope from occurrence in function scope', () => {
  ...
  `;
    const expected = new SourceLocationTestResult(1, 4, 1, 5);
    const actual = (0, index_1.findDeclaration)(code, context, { line: 4, column: 9 });
    expectResultsToMatch(actual, expected);
    expect(actual).toMatchSnapshot();
});
...
test('Find no declaration from occurrence when there is no declaration (syntax error)', () => {
  ...
  `;
    const expected = null;
    const actual = (0, index_1.findDeclaration)(code, context, { line: 5, column: 0 });
    expectResultsToMatch(actual, expected);
    expect(actual).toMatchSnapshot();
});
test('Find no declaration from selection that does not refer to a declaration', () => {
  ...
  `;
    const expected = null;
    const actual = (0, index_1.findDeclaration)(code, context, { line: 4, column: 3 });
    expectResultsToMatch(actual, expected);
    expect(actual).toMatchSnapshot();
});
...
test('Find function param declaration', () => {
  ...
  `;
    ...
    const actual = (0, index_1.findDeclaration)(code, context, { line: 2, column: 9 });
    expectResultsToMatch(actual, expected);
    expect(actual).toMatchSnapshot();
});
test('Find variable declaration with same name as function param declaration', () => {
  ...
  `;
    ...
    const actual = (0, index_1.findDeclaration)(code, context, { line: 5, column: 9 });
    expectResultsToMatch(actual, expected);
    // expect(actual).toMatchSnapshot()
});
...
test('Find declaration in init of for loop', () => {
  ...
  `;
    ...
    const actual = (0, index_1.findDeclaration)(code, context, { line: 3, column: 10 });
    expectResultsToMatch(actual, expected);
    expect(actual).toMatchSnapshot();
});
...
test('Find variable declaration in block statement', () => {
  ...
  `;
    ...
    const actual = (0, index_1.findDeclaration)(code, context, { line: 3, column: 2 });
    expectResultsToMatch(actual, expected);
    expect(actual).toMatchSnapshot();
});
...
test('Find declaration of of variable in update statement of a for loop', () => {
  ...
  `;
    ...
    const actual = (0, index_1.findDeclaration)(code, context, { line: 1, column: 17 });
    expectResultsToMatch(actual, expected);
    expect(actual).toMatchSnapshot();
});
test('Find scope of a variable declaration', () => {
    ...
    const actual = (0, index_1.getScope)(code, context, { line: 2, column: 10 });
    expected.forEach((expectedRange, index) => {
        const actualRange = new SourceLocationTestResult(actual[index].start.line, actual[index].start.column, actual[index].end.line, actual[index].end.column);
...
test('Find scope of a nested variable declaration', () => {
    ...
    const actual = (0, index_1.getScope)(code, context, { line: 4, column: 15 });
    expected.forEach((expectedRange, index) => {
        const actualRange = new SourceLocationTestResult(actual[index].start.line, actual[index].start.column, actual[index].end.line, actual[index].end.column);
        expectResultsToMatch(actualRange, expectedRange);
    });
...
test('Find scope of a function parameter', () => {
    ...
    const actual = (0, index_1.getScope)(code, context, { line: 5, column: 19 });
    expected.forEach((expectedRange, index) => {
        const actualRange = new SourceLocationTestResult(actual[index].start.line, actual[index].start.column, actual[index].end.line, actual[index].end.column);
        expectResultsToMatch(actualRange, expectedRange);
    });
...
test('Find scope of a function declaration', () => {
    ...
    const expected = [new SourceLocationTestResult(3, 4, 8, 5)];
    const actual = (0, index_1.getScope)(code, context, { line: 5, column: 17 });
    expected.forEach((expectedRange, index) => {
        const actualRange = new SourceLocationTestResult(actual[index].start.line, actual[index].start.column, actual[index].end.line, actual[index].end.column);
        expectResultsToMatch(actualRange, expectedRange);
    });
...
test('Find scope of a variable declaration with multiple blocks', () => {
    ...
    const actual = (0, index_1.getScope)(code, context, { line: 3, column: 15 });
    expected.forEach((expectedRange, index) => {
        const actualRange = new SourceLocationTestResult(actual[index].start.line, actual[index].start.column, actual[index].end.line, actual[index].end.column);
        expectResultsToMatch(actualRange, expectedRange);
    });
