...
describe('standard opcodes', () => {
    test('LGCI works', () => {
        return (0, testing_1.expectDisplayResult)(`display(123);`, { chapter: 3, variant: 'concurrent' })
    ...
    test('LGCF64 works', () => {
        return (0, testing_1.expectDisplayResult)(`display(1.5);`, { chapter: 3, variant: 'concurrent' })
            .toMatchInlineSnapshot(`
              Array [
                "1.5",
              ]
    ...
    test('LGCB0 works', () => {
        return (0, testing_1.expectDisplayResult)(`display(false);`, { chapter: 3, variant: 'concurrent' })
            .toMatchInlineSnapshot(`
              Array [
                "false",
              ]
    ...
    test('LGCB1 works', () => {
        return (0, testing_1.expectDisplayResult)(`display(true);`, { chapter: 3, variant: 'concurrent' })
            .toMatchInlineSnapshot(`
              Array [
                "true",
              ]
    ...
    test('LGCU works', () => {
        return (0, testing_1.expectDisplayResult)(`display(undefined);`, { chapter: 3, variant: 'concurrent' })
            .toMatchInlineSnapshot(`
              Array [
                "undefined",
              ]
    ...
    test('LGCN works', () => {
        return (0, testing_1.expectDisplayResult)(`display(null);`, { chapter: 3, variant: 'concurrent' })
            .toMatchInlineSnapshot(`
              Array [
                "null",
              ]
    ...
    test('LGCS works', () => {
        return (0, testing_1.expectDisplayResult)(`display("test string");`, { chapter: 3, variant: 'concurrent' })
            .toMatchInlineSnapshot(`
              Array [
                "\\"test string\\"",
              ]
    ...
    test('ADDG works for numbers', () => {
        return (0, testing_1.expectDisplayResult)('display(-1+1);', { chapter: 3, variant: 'concurrent' })
            .toMatchInlineSnapshot(`
              Array [
                "0",
              ]
    ...
    test('ADDG works for strings', () => {
        return (0, testing_1.expectDisplayResult)('display("first"+"second");', { chapter: 3, variant: 'concurrent' })
            .toMatchInlineSnapshot(`
              Array [
                "\\"firstsecond\\"",
              ]
    ...
    test('SUBG works for numbers', () => {
        return (0, testing_1.expectDisplayResult)('display(123-124);', { chapter: 3, variant: 'concurrent' })
            .toMatchInlineSnapshot(`
              Array [
                "-1",
              ]
    ...
    test('MULG works for numbers', () => {
        return (0, testing_1.expectDisplayResult)('display(123*2);', { chapter: 3, variant: 'concurrent' })
            .toMatchInlineSnapshot(`
              Array [
                "246",
              ]
    ...
    test('DIVG works for numbers', () => {
        return (0, testing_1.expectDisplayResult)('display(128/32);', { chapter: 3, variant: 'concurrent' })
            .toMatchInlineSnapshot(`
              Array [
                "4",
              ]
    ...
    test('DIVG fails for division by 0', () => {
        return (0, testing_1.expectParsedError)('128/0;', { chapter: 3, variant: 'concurrent' }).toMatchInlineSnapshot(`"Error: execution aborted: division by 0"`);
    });
    ...
    test('MODG works for numbers', () => {
        return (0, testing_1.expectDisplayResult)('display(128%31);', { chapter: 3, variant: 'concurrent' })
            .toMatchInlineSnapshot(`
              Array [
                "4",
              ]
    ...
    test('STLG and LDLG works', () => {
        return (0, testing_1.expectDisplayResult)(`const x = 1; display(x);`, { chapter: 3, variant: 'concurrent' })
            .toMatchInlineSnapshot(`
              Array [
                "1",
              ]
...
describe('primitive opcodes', () => {
    ...
    test('nullary handler', () => {
        return (0, testing_1.snapshotSuccess)('get_time();', { chapter: 3, variant: 'concurrent' });
    });
    test('unary handler', () => {
        return (0, testing_1.expectDisplayResult)((0, formatters_1.stripIndent) `
          display(math_abs(-1));
...
describe('standard program execution', () => {
    test('program always returns all threads terminated', () => {
        return (0, testing_1.expectResult)('1 + 1;', { chapter: 3, variant: 'concurrent' }).toBe('all threads terminated');
    });
    ...
    test('program times out', () => {
        return (0, testing_1.expectParsedError)('while(true) {}', { chapter: 3, variant: 'concurrent' })
            .toMatchInlineSnapshot(`
...
test('concurrent program execution interleaves', () => {
  ...
  `;
    return (0, testing_1.getDisplayResult)(code, { chapter: 3, variant: 'concurrent' }).then(displayResult => {
...
test('concurrent program execution interleaves (busy wait)', () => {
  ...
  `;
    return (0, testing_1.getDisplayResult)(code, { chapter: 3, variant: 'concurrent' });
});
