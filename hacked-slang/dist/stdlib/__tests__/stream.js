...
describe('primitive stream functions', () => {
    test('empty stream is null', () => {
        return (0, testing_1.expectResult)('stream();', { chapter: 3, native: true }).toBe(null);
    });
    test('stream_tail works', () => {
        return (0, testing_1.expectResult)(`head(stream_tail(stream(1, 2)));`, { chapter: 3, native: true }).toBe(2);
    });
