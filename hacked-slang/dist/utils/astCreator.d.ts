...
export declare const declaration: (name: string, kind: AllowedDeclarations, init: es.Expression, loc?: es.SourceLocation | null | undefined) => es.VariableDeclaration;
export declare const constantDeclaration: (name: string, init: es.Expression, loc?: es.SourceLocation | null | undefined) => es.VariableDeclaration;
export declare const callExpression: (callee: es.Expression, args: es.Expression[], loc?: es.SourceLocation | null | undefined) => es.CallExpression;
export declare const expressionStatement: (expression: es.Expression) => es.ExpressionStatement;
export declare const blockArrowFunction: (params: es.Identifier[], body: es.Statement[] | es.BlockStatement, loc?: es.SourceLocation | null | undefined) => es.ArrowFunctionExpression;
export declare const functionExpression: (params: es.Pattern[], body: es.Statement[] | es.BlockStatement, loc?: es.SourceLocation | null | undefined) => es.FunctionExpression;
...
export declare const returnStatement: (argument: es.Expression, loc?: es.SourceLocation | null | undefined) => es.ReturnStatement;
...
export declare const logicalExpression: (operator: es.LogicalOperator, left: es.Expression, right: es.Expression, loc?: es.SourceLocation | null | undefined) => es.LogicalExpression;
...
export declare const conditionalExpression: (test: es.Expression, consequent: es.Expression, alternate: es.Expression, loc?: es.SourceLocation | null | undefined) => es.ConditionalExpression;
...
export declare const binaryExpression: (operator: es.BinaryOperator, left: es.Expression, right: es.Expression, loc?: es.SourceLocation | null | undefined) => es.BinaryExpression;
export declare const unaryExpression: (operator: es.UnaryOperator, argument: es.Expression, loc?: es.SourceLocation | null | undefined) => es.UnaryExpression;
...
export declare const arrowFunctionExpression: (params: es.Pattern[], body: es.Expression | es.BlockStatement, loc?: es.SourceLocation | null | undefined) => es.ArrowFunctionExpression;
...
export declare const variableDeclarator: (id: es.Pattern, init: es.Expression, loc?: es.SourceLocation | null | undefined) => es.VariableDeclarator;
export declare const ifStatement: (test: es.Expression, consequent: es.BlockStatement, alternate: es.Statement, loc?: es.SourceLocation | null | undefined) => es.IfStatement;
export declare const whileStatement: (body: es.BlockStatement, test: es.Expression, loc?: es.SourceLocation | null | undefined) => es.WhileStatement;
